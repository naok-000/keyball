...
#define L2_CTRL_A_GUI LGUI_T(KC_F17)
#define L2_CTRL_S_ALT LALT_T(KC_F17)
#define L2_CTRL_EQL_SFT LSFT_T(KC_F17)
#define L2_CTRL_F_CTL LCTL_T(KC_F17)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [2] = LAYOUT(
	       LCTL(KC_Q)       , LCTL(KC_W)     , XXXXXXX        , LSFT(LCTL(KC_R)),LCTL(KC_T)     ,                               LSFT(LCTL(KC_Z)),LCTL(KC_1)   , LCTL(KC_2)    , LCTL(KC_3)    , LCTL(KC_4)     ,
	       L2_CTRL_A_GUI    , L2_CTRL_S_ALT  , L2_CTRL_EQL_SFT, L2_CTRL_F_CTL  , XXXXXXX        ,                               KC_LEFT       , KC_DOWN       , KC_UP         , KC_RIGHT      , XXXXXXX        ,
	       LCTL(KC_Z)       , LCTL(KC_X)     , LCTL(KC_C)     , LCTL(KC_V)     , XXXXXXX        ,                               XXXXXXX       , LCTL(KC_LBRC) , LSFT(LCTL(KC_LBRC)),LSFT(LCTL(KC_RBRC)),LCTL(KC_RBRC),
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    switch (keycode) {
        ...
        case L2_CTRL_A_GUI:
            return process_custom_mod_tap(LCTL(KC_A), record);

        case L2_CTRL_S_ALT:
            return process_custom_mod_tap(LCTL(KC_S), record);

        case L2_CTRL_EQL_SFT:
            return process_custom_mod_tap(LCTL(KC_EQL), record);

        case L2_CTRL_F_CTL:
            return process_custom_mod_tap(LCTL(KC_F), record);
